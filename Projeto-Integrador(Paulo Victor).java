...
public class Atividade {
    ...
    public Atividade(String descricao, Date dataInicio, Date dataFim, Usuario usuarioResponsavel, Departamento departamentoResponsavel) {
        this.descricao = descricao;
...
public class Cadastro {
        ...
        public void cadastro() {
            try {
                ...
                System.out.println("**Fazer cadastro de usuário**");
                ...
                if (decide == 1) {
                    ...
                    if (usuario1.validarSenha(validaSenha)) {
                        ...
                        System.out.println("Bem-Vindo ao Kanban");
                        System.out.println("\nDeseja cadastrar uma empresa nessa conta");
                        System.out.println("1 SIM, 2 NÃO");
                        int cadastraEmprea = sc.nextInt();
                        sc.nextLine();
                        ...
                        System.out.println("\nAgora vamos cadastrar um projeto: ");
                        ...
                        if (simNao.equals("SIM")) {
                            for (int i = 0; i < 20; i++) {
                                ...
                                Atividade tarefa = new Atividade(descricaoTarefa, dateInicioTarefa, dateFimTarefa, usuario1, departamento);
